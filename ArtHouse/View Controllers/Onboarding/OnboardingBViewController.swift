...
class OnboardingViewControllerB: UIViewController, PaperOnboardingDelegate, PaperOnboardingDataSource {
    
    private static let titleFont = UIFont(name: "AvenirNext-Bold", size: 20.0)!
    private static let descriptionFont = UIFont(name: "Apple SD Gothic Neo", size: 18.0) ?? UIFont.systemFont(ofSize: 14.0)
    var avPlayer: AVPlayer!
    
    fileprivate let items = [
        OnboardingItemInfo(informationImage: UIImage(named: "camera.png")!,
